  ...
  const renderTableData = () => {
    return data.map((item) => {
      return (
        <tr
          key={item._id}
          className="border-b text-black bg-white hover:bg-orange-600 hover:text-black"
        >
          <td className="px-2 text-center break-words">
          ...
          <td className=" py-4 px-1 flex content-center ">
            <div
    ...
    <div className="container mx-auto pt-2 pb-10">
      <div className="relative overflow-x-auto shadow-sm sm:rounded-lg">
        <table className="w-full table-fixed text-sm text-left text-black">
          <thead className="text-md uppercase text-black bg-white">
            <tr>
              <th scope="col" className="text-center w-6/12">
                FullUrl
              </th>
              <th scope="col" className="text-center w-6/12">
                ShortUrl
